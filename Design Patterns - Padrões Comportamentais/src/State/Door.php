...
use SON\State\DoorStates\ClosedDoorState;
use SON\State\DoorStates\DoorState;
use SON\State\DoorStates\LockedDoorState;
use SON\State\DoorStates\OpenDoorState;
